    ...
    <div className="max-w-2xl space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-bold text-white tracking-tight">Workspace</h1>
      ...
      <div className="bg-[#111111] border border-[#ffffff0d] rounded-md divide-y divide-[#ffffff08]">
        ...
        <div className="p-5 space-y-5">
          <div className="space-y-1.5">
            <Label className="text-xs text-gray-400 font-medium" htmlFor="workspaceName">
          ...
          <div className="space-y-1.5">
            <Label className="text-xs text-gray-400 font-medium" htmlFor="workspaceId">
              ID del Workspace
            </Label>
            <div className="flex items-center gap-2">
              <Input
                ...
                value={id}
                readOnly
                className="bg-[#1a1a1a] border-white/10 text-gray-400 font-mono text-xs h-9 focus-visible:ring-0 select-all"
              />
              <Button
                variant="outline"
                size="icon"
                onClick={handleCopyId}
                className="h-9 w-9 bg-[#1a1a1a] border-white/10 text-gray-400 hover:text-white hover:bg-white/5 shrink-0"
              >
      ...
      <div className="bg-red-950/10 border border-red-900/30 rounded-md p-5 space-y-3">
        ...
        <Button
          disabled
          variant="destructive"
          className="mt-2 h-9 text-xs opacity-50 cursor-not-allowed bg-red-900 text-white border-none"
